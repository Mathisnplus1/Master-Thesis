...
def get_task_loaders(data_path, batch_size, global_seed, random_seed, train_percentage=0.7, difficulty="standard", download=False) :
...
def get_train_and_val_loaders(data_path, batch_size, global_seed, random_seed, train_percentage=0.7, difficulty="standard", download=False) :
